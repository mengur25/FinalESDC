...
import { Box, Button, TextField, Rating, Typography, Paper, CircularProgress } from '@mui/material';
...
const WriteReview = () => {
    ...
    return (
        <Box className="max-w-xl mx-auto p-5 mt-10" component={Paper} elevation={3}>
            <Typography variant="h5" component="h1" gutterBottom className="font-bold">
                Write a Review
            </Typography>
