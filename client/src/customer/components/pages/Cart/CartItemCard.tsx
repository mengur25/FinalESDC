...
import { Checkbox, Divider, IconButton, Button } from "@mui/material";
...
const CartItemCard = ({ item, isSelected, onToggle }: Props) => {
  ...
  return (
    <div className="border rounded-sm relative flex gap-3 items-start p-3">
      <Checkbox checked={isSelected} onChange={onToggle} /> {/* ✅ Checkbox */}
